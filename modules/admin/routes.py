...
async def update_settings(
    ...
    top_credit_fee_percent: str = Form("3"),
    ...
    updates = {
        ...
        "invoice_seller_info": invoice_seller_info.strip(),
        ...
        "default_gateway": default_gateway if default_gateway in (enabled_gateways or []) else "",
        "top_credit_fee_percent": top_credit_fee_percent.strip() if top_credit_fee_percent else "3",
