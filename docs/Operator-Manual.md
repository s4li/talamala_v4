...
> این راهنما بر اساس قابلیت‌های فعلی سیستم TalaMala v4 (فازهای ۱-۱۴ + صفحات ثابت و فوتر + ثبت مالکیت و انتقال شمش + ادغام Location در Dealer + لاگ درخواست‌ها + مدیریت کاربران + ویرایش مشتری توسط ادمین) نوشته شده است.
