...
12. [عیب‌یابی (Troubleshooting)](#12-عیبیابی)
13. [واژه‌نامه](#13-واژهنامه)
...
بخش مدیریت کاربران به اپراتور امکان مشاهده لیست تمام مشتریان ثبت‌نام‌شده، جستجو و فیلتر، و بررسی جزئیات هر مشتری (اطلاعات پروفایل، تراکنش‌های کیف پول، سفارشات و درخواست‌های برداشت) را می‌دهد.
...
**تب خلاصه (Overview):**
- اطلاعات مشتری: نام، موبایل، کد ملی، تاریخ ثبت‌نام
...
> این راهنما بر اساس قابلیت‌های فعلی سیستم TalaMala v4 (فازهای ۱-۱۴ + صفحات ثابت و فوتر + ثبت مالکیت و انتقال شمش + ادغام Location در Dealer + لاگ درخواست‌ها + مدیریت کاربران) نوشته شده است.
