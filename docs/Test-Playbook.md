...
| ID | اقدام | ورودی | نتیجه مورد انتظار | وضعیت |
|----|--------|-------|-------------------|--------|
| TS-16-08 | باز کردن صفحه ثبت مالکیت از منو | لاگین U4 → منوی کشویی → «ثبت شمش» | هدایت به `/claim-bar` + فرم با فیلدهای سریال‌کد و کد ثبت مالکیت نمایش شود | ☐ |
...
| TS-16-13 | ثبت مالکیت بدون لاگین | بدون لاگین → مراجعه مستقیم به صفحه ثبت مالکیت | ریدایرکت به صفحه ورود | ☐ |
...
| ID | اقدام | ورودی | نتیجه مورد انتظار | وضعیت |
|----|--------|-------|-------------------|--------|
| TS-16-14 | مشاهده لیست شمش‌ها | لاگین U3 → منوی کشویی → «شمش‌های من» | لیست شمش‌های متعلق به مشتری با سریال‌کد، نام محصول، وزن، عیار | ☐ |
| TS-16-15 | مشتری بدون شمش | لاگین U5 (بدون شمش) → منوی کشویی → «شمش‌های من» | پیام «هیچ شمشی ثبت نشده» یا لیست خالی | ☐ |
