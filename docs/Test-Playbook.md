...
19. [TS-NEG: تست‌های منفی (Negative Tests)](#19-ts-neg-تستهای-منفی)
...
> این سند بر اساس قابلیت‌های فعلی سیستم TalaMala v4 (فازهای ۱-۱۴ + بازپرداخت اجرت بازخرید + بهبودهای تیکتینگ + صفحات ثابت و فوتر + ثبت مالکیت و انتقال شمش + ادغام Location در Dealer + لاگ درخواست‌ها + مدیریت کاربران) تهیه شده است.
