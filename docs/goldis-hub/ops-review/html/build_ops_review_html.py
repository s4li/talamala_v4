...
<head>
  ...
  <title>{title}</title>
  <link rel="stylesheet" href="assets/print-safe.css">
</head>
<body>
...
<div class="instructions-box">
  ...
  <ol>
    ...
    <li>تنظیمات پیشنهادی برای چاپ فیزیکی امن:
      <ul>
        <li><strong>کاغذ:</strong> A4</li>
        <li><strong>جهت:</strong> عمودی (Portrait)</li>
        <li><strong>حاشیه:</strong> Default</li>
        <li><strong>مقیاس:</strong> ۸۵٪ تا ۹۰٪</li>
        <li><strong>Headers and footers:</strong> غیرفعال (Off)</li>
        <li><strong>Background graphics:</strong> فعال (On)</li>
      </ul>
    </li>
    <li>اگر محتوا به لبه صفحه نزدیک بود:
      <ul>
        <li><strong>حاشیه:</strong> Custom</li>
        <li><strong>بالا:</strong> 1 inch &nbsp;|&nbsp; <strong>پایین:</strong> 1 inch</li>
        <li><strong>چپ:</strong> 0.7 inch &nbsp;|&nbsp; <strong>راست:</strong> 0.7 inch</li>
        <li><strong>مقیاس:</strong> ۸۵٪</li>
      </ul>
    </li>
  </ol>
</div>
