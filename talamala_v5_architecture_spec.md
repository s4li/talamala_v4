...
### ۱۴.۱ D-96: Payment Reconciliation — مطابقت‌دهی قیمت
...
### ۱۴.۲ D-97: Pending Reserves — رزرو بر روی Checkout
...
### ۱۴.۳ D-98: Payment State Machine — منع پول یتیم
...
### ۱۴.۴ D-99: POS Offline Queue — دستگاه‌های بدون اینترنت
