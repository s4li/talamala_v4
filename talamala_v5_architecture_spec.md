...
### تصمیمات جلسه‌ی بازبینی 2026-05-16 (Override — D-46…D-57)
...
> **⚠️ اثر روی scope/تخمین:** D-47، D-48 و D-53 scope را نسبت به سند اولیه سنگین‌تر کرده‌اند (supplier_purchase که خارج بود حالا داخل است؛ سقف دوطرفه؛ گیت ثبت‌مالکیت در بازخرید). تخمین ۱۲ هفته‌ی بخش ۲۲ باید با لحاظ این‌ها بازبینی شود.
