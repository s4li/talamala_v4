...
> **نسخه:** 2.2 (بازبینیِ خارجی + اصلاحاتِ P0 — 2026-05-18)
> **نسخه قبل:** 2.1 (Revised — جلسه‌ی بازبینیِ عمیقِ 2026-05-16…18)
> **تاریخ:** 2026-05-18
> **وضعیت:** آماده برای پیاده‌سازی (تمام P0/P1 issues fixed)
> **منبع:** سه دور Q&A با تیم Goldis Ops + ادغام ChatGPT + DeepSeek review + ۳۵ تصمیمِ اصلاحیِ بازبینی (D-46…D-80) + ۶ اصلاحِ P0 schema
...
## ۲.۶. اصلاحات P0 — Schema Implementation Fixes (نسخه ۲.۲)

این بخش تصریح می‌کند P0 bugs شناخته‌شده از بازبینیِ خارجی (ChatGPT + DeepSeek، 2026-05-18) که درون سند ۲.۱ تکرار شدند و در v2.2 رفع شدند:
