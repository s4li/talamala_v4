...
> **نسخه:** 2.3 (بازبینیِ خارجی دوم + اصلاحاتِ P0 تکمیلی — 2026-05-18)
> **نسخه قبل:** 2.2 (بازبینیِ خارجی + اصلاحاتِ P0 اولیه — 2026-05-18)
> **تاریخ:** 2026-05-18
> **وضعیت:** آماده برای پیاده‌سازی (تمام P0/P1 issues fixed — 10 اصلاح P0+P1)
