...
> **تاریخ:** 2026-05-18
> **وضعیت:** ✅✅✅ آماده برای پیاده‌سازی — implementation-safe (۴ subsystem D-90–D-93 برای امنیتِ مالیِ تولید)
...
30. **Dealer commission settlement + treasury/inter-company offset** (D-95): تسویه‌ی بدهیِ کمیسیونِ نماینده‌ای توسط TalaMala به Goldis؛ offset مقابل هزینه‌های treasury (hedge buy، supplier purchase)؛ سناریو: TalaMala از نماینده‌ها X طلا درآمد بخشی کمیسیون؛ Goldis به TalaMala −X طلا بابت supplier purchase تحویل داده؛ دو تعهد ممکن offset شوند.
...
1. **D-90: Payment Reconciliation** — جلوگیری از پول‌های گیر‌افتاده اگر قیمت بین lock و payment تغییر کند
2. **D-91: Pending Reserves** — منع از نقض سقف خزانه به سبب condition race
3. **D-92: Payment State Machine** — بازیابی خودکار پرداخت‌های orphaned بعد از crash
4. **D-93: POS Offline Queue** — پشتیبانی از دستگاه‌های بدون اینترنت پایا

---

### ۱۴.۱ D-90: Payment Reconciliation — مطابقت‌دهی قیمت
...
### ۱۴.۲ D-91: Pending Reserves — رزرو بر روی Checkout
...
### ۱۴.۳ D-92: Payment State Machine — منع پول یتیم
...
### ۱۴.۴ D-93: POS Offline Queue — دستگاه‌های بدون اینترنت
